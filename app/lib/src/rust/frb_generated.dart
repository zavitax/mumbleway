...
abstract class RustLibApi extends BaseApi {
  ...
  Future<UiProbe> crateApiMumblewayAudioProbeChain();
  ...
  Future<String> crateApiMumblewayBuildInviteWebLink({
    required ServerConfig config,
    String? channel,
    required bool includePassword,
  });
  ...
  void crateApiMumblewayClearClassifierVoice();
  ...
  bool crateApiMumblewayIsSimpleModel();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<UiProbe> crateApiMumblewayAudioProbeChain() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_ui_probe,
          decodeErrorData: sse_decode_AnyhowException,
        ),
        constMeta: kCrateApiMumblewayAudioProbeChainConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMumblewayAudioProbeChainConstMeta =>
      const TaskConstMeta(debugName: "audio_probe_chain", argNames: []);
  ...
  Future<String> crateApiMumblewayBuildInviteWebLink({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiMumblewayBuildInviteWebLinkConstMeta,
        argValues: [config, channel, includePassword],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMumblewayBuildInviteWebLinkConstMeta =>
      const TaskConstMeta(
        debugName: "build_invite_web_link",
        argNames: ["config", "channel", "includePassword"],
      );
  ...
  void crateApiMumblewayClearClassifierVoice() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMumblewayClearClassifierVoiceConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMumblewayClearClassifierVoiceConstMeta =>
      const TaskConstMeta(debugName: "clear_classifier_voice", argNames: []);
  ...
  bool crateApiMumblewayIsSimpleModel() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMumblewayIsSimpleModelConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMumblewayIsSimpleModelConstMeta =>
      const TaskConstMeta(debugName: "is_simple_model", argNames: []);
  ...
  void crateApiMumblewaySetClassifierVoice({required bool voice}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMumblewaySetClassifierVoiceConstMeta,
        argValues: [voice],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMumblewaySetClassifierVoiceConstMeta =>
      const TaskConstMeta(
        debugName: "set_classifier_voice",
        argNames: ["voice"],
      );
  ...
  void crateApiMumblewaySetSimpleModel({required bool on_}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiMumblewaySetSimpleModelConstMeta,
        argValues: [on_],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiMumblewaySetSimpleModelConstMeta =>
  ...
  UiChainStatus sse_decode_ui_chain_status(SseDeserializer deserializer) {
    ...
    var var_aec3 = sse_decode_bool(deserializer);
  ...
  void sse_encode_ui_chain_status(
    ...
    sse_encode_bool(self.aec3, serializer);
