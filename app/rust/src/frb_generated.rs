...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -574715263;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        41 => wire__crate__api__mumbleway__ping_server_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        39 => wire__crate__api__mumbleway__output_level_db_impl(ptr, rust_vec_len, data_len),
        40 => wire__crate__api__mumbleway__output_volume_db_impl(ptr, rust_vec_len, data_len),
        42 => wire__crate__api__mumbleway__play_participant_cue_impl(ptr, rust_vec_len, data_len),
        43 => wire__crate__api__mumbleway__play_test_tone_impl(ptr, rust_vec_len, data_len),
        44 => wire__crate__api__mumbleway__preview_clear_impl(ptr, rust_vec_len, data_len),
        45 => wire__crate__api__mumbleway__preview_push_impl(ptr, rust_vec_len, data_len),
        46 => wire__crate__api__mumbleway__preview_push_processed_impl(ptr, rust_vec_len, data_len),
        47 => wire__crate__api__mumbleway__preview_queued_impl(ptr, rust_vec_len, data_len),
        48 => wire__crate__api__mumbleway__preview_reset_chain_impl(ptr, rust_vec_len, data_len),
        49 => wire__crate__api__mumbleway__recent_logs_impl(ptr, rust_vec_len, data_len),
        51 => wire__crate__api__mumbleway__reset_audio_glitches_impl(ptr, rust_vec_len, data_len),
        55 => wire__crate__api__mumbleway__set_background_noisy_impl(ptr, rust_vec_len, data_len),
