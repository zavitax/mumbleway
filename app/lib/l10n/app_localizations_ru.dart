...
class LRu extends L {
  ...
  String get syncBodyAndroid =>
      'Серверы и настройки входят в резервную копию Android и вернутся при настройке нового телефона. Но пока вы пользуетесь двумя телефонами, они их не синхронизируют.';
