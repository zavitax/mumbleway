...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    if (WIN32)
        # MumbleWay: libopus is built from source by the `audiopus_sys` crate
        # using CMake. That nested CMake runs *inside* this MSBuild invocation,
        # and its Visual Studio generator inherits the outer build's MSBuild
        # state -- its compiler-probe project (VCTargetsPath.vcxproj) then dies
        # with "item metadata %(FullPath) cannot be applied to ...tlog".
        #
        # Ninja sidesteps the problem entirely by not going through MSBuild.
        # It ships with the Visual Studio CMake component, so it is available
        # wherever this build works at all. Scoped to WIN32 deliberately:
        # forcing Ninja on macOS/iOS/Android would break those builds, where the
        # default generator is correct and Ninja may not be installed.
        list(APPEND CARGOKIT_ENV "CMAKE_GENERATOR=Ninja")
