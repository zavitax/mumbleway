...
class LRu extends L {
  ...
  String get noiseAutoBody =>
      'Слушает фон и сам выбирает один из вариантов выше — по тому, насколько голос поднимается над фоном в первую секунду фразы. Обратно возвращается медленнее: пятнадцать секунд тишины, чтобы уйти со шлемного режима, и ещё минута до самого лёгкого. Пригодится, когда одна поездка охватывает и тихую парковку, и трассу.';
