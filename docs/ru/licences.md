...
записанном звуке из-под шлема, — и упомянут здесь потому, что использовался при
...
- Это **«Apache 2.0 с дополнительными условиями»**, а не просто Apache 2.0.
  Дополнительные условия существуют на самом деле, и лучше прочитать
  `LICENSE` первоисточника, а не исходить из условий Apache.
...
Сама эта оценка несёт **опровержение** в начале того же README: измерения, на
которых она построена, были сделаны на звуке с собственного микрофона телефона,
а не с выносного микрофона гарнитуры, и два вывода в результате отозваны. Текст
...
**Достоверным является текст, поставляемый с каждым пакетом.** Некоторые крейты
Rust лицензированы двойной лицензией MIT *или* Apache-2.0 на ваш выбор и
отмечены выше как «MIT / Apache-2.0».
